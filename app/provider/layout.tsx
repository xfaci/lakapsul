    ...
    return (
        <div className="flex min-h-screen bg-background">
            ...
            <div className="flex-1 flex flex-col min-h-screen overflow-hidden relative z-10">
                {/* Top Header */}
                <header className="h-16 border-b border-white/10 bg-background/40 backdrop-blur-xl flex items-center justify-between px-4 md:px-6 sticky top-0 z-40">
                    ...
                    <div className="flex items-center gap-2 md:gap-4">
                        ...
                        <div className="h-8 w-8 rounded-full bg-gradient-to-br from-primary to-purple-600 flex items-center justify-center font-bold text-white text-sm shadow-lg shadow-primary/20">
                            ST
                        </div>
                    </div>
                </header>
